        ...
        with torch.no_grad():
            ...
            if self.tracer:
                self.tracer.log_step("source_processing", "after_predict_embed",
                                   source_warp_embed_dict=source_warp_embed_dict,
                                   target_warp_embed_dict=target_warp_embed_dict,
                                   mixing_warp_embed_dict=mixing_warp_embed_dict,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--debug', default=True, action='store_true', help='Enable debug tracing')
